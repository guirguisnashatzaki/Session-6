...
if __name__ == "__main__": 
    ...
    gui.geometry("465x350")  
    equation = StringVar() 
    expression_field = Entry(gui, textvariable=equation,font=('Times New Roman', 12, 'bold'))  
    expression_field.grid(columnspan=4, ipadx=150,ipady=20) 
